export const en = {
  ...
  Horizontalscroll: {
    title: "our work",
    viewmoreicon: "✦ VIEW ✦ MORE ✦ VIEW ✦ MORE",
  ...
  project: {
    ...
    fastpro: {
      description:
        "We had the privilege of participating in the creation of FAST PRO, a new brand of automotive service centers established by Foramag. After making the strategic decision not to renew the MIDAS license in 2018, Foramag sought to bring a breath of fresh air while retaining the expertise of its teams. We supported this transformation by creating a new visual identity, ensuring that the same professionals—automotive maintenance experts—continue to deliver quality service in the renovated and rebranded garages. Our mission was to build clear and engaging communication around this evolution, highlighting the continuity of excellent service while asserting this dynamic and modern new image.",
      logo: {
        title: "The Logo",
        description:
          "As part of the rebranding of FAST PRO, we designed a logo that reflects the values of speed, performance, and expertise. This modern logo, with clean lines and carefully chosen colors, embodies Foramag’s innovative vision for its automotive service centers. Through this design, we aimed to symbolize FAST PRO’s commitment to providing quick and quality service while maintaining a strong connection to the brand’s core values.",
      },
      campaign: {
        title: "The Campaign",
        description:
      ...
      centers: {
        title: "The Centers",
        description:
          "The new FAST PRO service centers offer an entirely new customer experience, with modernized garages, a polished atmosphere, and state-of-the-art equipment. We reimagined every visual and functional aspect of these centers to provide a smoother, more enjoyable experience while ensuring the expertise and quality service that have built Foramag’s reputation. These new centers reflect the brand’s commitment to evolve while staying true to its values of competence, speed, and professionalism. Through this transformation, we helped make every visit to these centers a moment of trust and reassurance for customers.",
      },
    },

    seat: {
      description:
        "After introducing 'Level Up', marking the new strategic partnership between SEAT and CAC, its new importer, it became essential to affirm the brand's DNA and solidify its identity. This vision came to life through the SEAT Attitude campaign, which activated four key platforms represented by renowned ambassadors: Othman Choufani, Lilias Tebbai, ReqTeq, Aezaddy, Aidance, Sara Morbi, and Sika. This campaign brilliantly highlighted SEAT’s core values, encapsulated by its signature 'Born in the Sun'. More than just a car, SEAT offers its customers a unique experience and mindset, celebrating a dynamic and inspiring lifestyle.",
      filmad:
        "Discover SEAT’s universe through 6 captivating videos, each telling a unique story of the SEAT Attitude campaign.",
      ooh: "The SEAT Attitude campaign also stood out through a series of video displays designed to showcase the SEAT Arona and SEAT Ateca. Each video highlights a unique aspect of SEAT’s universe, brought to life by our ambassadors and their passions. From the freedom of the waves to urban dynamism, these displays reflect the essence of SEAT Attitude: a bold, vibrant, and resolutely modern mindset embodied by these two iconic models.",
      print: {
        title: "Prints",
        description:
          "The SEAT Attitude campaign also extended to Moroccan press with two prominent publications, showcasing the SEAT Arona and SEAT Ateca. These features reflect the brand’s universe while highlighting the distinctive lines and strengths of these two iconic models. Published in strategic outlets, these pieces further amplify the campaign’s impact and solidify the SEAT Attitude spirit among the Moroccan audience.",
      },
      socialmedia:
    ...
    casabeer: {
      description:
        "'Feel The Spirit of Morocco' is an immersive celebration of Moroccan soul, blending authenticity and modernity through a unique multisensory campaign. Driven by exclusive collaborations with exceptional ambassadors – artist Blizzart for the limited-edition design, chef Baya for inspired recipes, and musician ReqTeq for the track and playlist 'Spirits of Morocco' – this initiative embodies Morocco's richness and diversity. From visual art to gastronomy and music, each collaboration amplifies the essence of the country, offering a holistic experience that unites local craftsmanship and cultural authenticity.",
      limitededition: {
    ...
    ainifrane: {
      description:
        "As part of our collaboration with Aïn Ifrane, we designed and deployed a comprehensive strategy encompassing all aspects of the brand, from digital to trade. This strategy revolves around the iconic claim, 'Ressourcez-vous où que vous soyez' ('Recharge wherever you are'), highlighting the importance of recharging in every moment of life. By developing impactful campaigns and creative concepts that embody this commitment, we also supported the launch of the 'Aïn Ifrane chez vous' delivery service, further strengthening the brand's connection with its consumers and its role as a trusted daily partner.",
      socialmedia:
        "In parallel, we orchestrated an ambitious digital deployment, blending innovation with consistency. A campaign focused on the 'Aïn Ifrane chez vous' home delivery service was launched to meet the modern needs of consumers while ensuring their daily replenishment. Simultaneously, we spread the new brand idea through captivating content and a strengthened presence across all digital platforms, ensuring optimal visibility and authentic engagement with the brand’s diverse audiences.",
      activation:
        "In response to the water shortage, Aïn Ifrane turned a challenge into an opportunity for meaningful engagement. By branding its trucks with a bold and unexpected message – 'Don’t wash me, water is scarce!' – the brand took a stand on a crucial social responsibility issue. This simple yet impactful gesture not only raised public awareness about the importance of conserving this precious resource but also reinforced Aïn Ifrane’s image as a committed and responsible brand. An initiative widely praised for its relevance and authenticity.",
    },
    expressrelais: {
      description:
    ...
    cupra: {
      ...
      events:
        "During the launch of Cupra in Morocco, we had the honor of welcoming the leaders of Cupra Spain for an exclusive press conference. This event marked the beginning of the evening. To offer a unique experience, we integrated artificial intelligence and augmented reality activations, immersing guests in the brand's futuristic universe. The Cupra NFT exhibition added an innovative digital touch, highlighting Cupra’s commitment to the future and technology. A memorable event that perfectly launched the brand in the Moroccan market.",
    },
    fso: {
      description:
        "Since half a century, Flag Spéciale has been part of the daily life of Moroccans. 50 years of shared moments, conviviality, and authentic flavors that have made it the most popular beer in the country. 50 years of being Spéciale, and to celebrate, we’ve prepared a year full of surprises, events, and exclusive offers.",
      socialmedia:
        "50 years of history, shared moments, and brewed passion, yet no one seemed to remember. So, Flag Spéciale decided to take matters into its own hands. First, a teaser on social media where the bottle, upset, was sulking at its audience. Then, the big reveal: no hard feelings, quite the opposite. To mark this historic milestone, we launched a full year of celebration with spectacular giveaways, exclusive promotions, and a tailor-made influencer strategy. After all, 50 years of being Spéciale deserves a celebration to match.",
      marchandising: {
        title: "The marchandising",
        description:
          "To mark its 50th anniversary, Flag Spéciale wanted to leave an impression beyond the glass. The idea? To offer its audience collector’s items, designed as souvenirs of a shared story that’s been unfolding for half a century. Iconic glasses, exclusive t-shirts, unique accessories… Each item tells a part of this journey, a bit of the passion that made Spéciale the most popular beer in Morocco.",
      },
    },
    vw: {
      title: "Volkswagen Cinema",
      description:
        "Volkswagen Maroc partners with the Fête du Cinéma to celebrate the 7th art in four major cities across Morocco. As the official sponsor, the brand shares this journey with the audience by offering a unique cinematic experience. This partnership is an opportunity to explore the world of cinema together, while highlighting the spirit of innovation and conviviality that defines Volkswagen. Through this event, the brand invites everyone to experience cinema in a new way, with passion and authenticity.",
      deployement: {
